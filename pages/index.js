                ...
                <div>
                    <Form>
                        <Form.Group controlId="pesoUsuario">
                            ...
                            <Form.Control type="text" required value={pesoUsuario} onChange={(event) => setPesoUsuario(event.target.value)}/>
                        </Form.Group>
                        <Form.Group controlId="tipoAtividade">
                            <Form.Label>Selecione o tipo de atividade física:</Form.Label>
                            <Form.Control as="select" required value={tipoAtividade} onChange={(event) => setTipoAtividade(event.target.value)}>
